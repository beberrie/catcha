...
public class NotificationAdapter extends
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        h.tvOrgName.setText(
                item.getType() == NotificationModel.Type.EVENT
                        ...
                        ? item.getPostedByName() : "Organization"));
        ...
        if (item.getType() == NotificationModel.Type.EVENT) {
            switch (item.getUrgency()) {
                case HOUR_1:
                    ...
                    h.tvTag.setTextColor(Color.parseColor("#E53935"));
                    break;
                case HOURS_24:
                    h.tvTag.setText("Event in 24 hours");
                    h.tvTag.setTextColor(Color.parseColor("#F57C00"));
                    break;
                default:
                    h.tvTag.setText("Upcoming Event");
                    h.tvTag.setTextColor(Color.parseColor("#888888"));
                    break;
            }
            ...
            h.tvEventGoing.setText(item.getEventGoing() + " Going");
        } else {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvOrgName, tvTag, tvTime, tvHeadline, tvBody, tvMarkAsRead;
        LinearLayout layoutEventCard, layoutAnnouncementCard;
        TextView tvEventTitle, tvEventDateTime, tvEventLocation, tvEventGoing;
