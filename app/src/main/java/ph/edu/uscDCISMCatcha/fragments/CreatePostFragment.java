...
public class CreatePostFragment extends Fragment {
    ...
    private void setupButtons() {
        ...
        binding.btnBroadcast.setOnClickListener(v -> {
            ...
            // Send to SharedAnnouncementViewModel
            // NotificationFragment observes this
            sharedViewModel.broadcastAnnouncement(
                    title,
                    message,
                    "Juan Dela Cruz",     // TODO: real user name
                    "Leader",             // TODO: real user role
                    "DCISM Organization", // TODO: real org name
                    312                   // TODO: real follower count
            );
        ...
        binding.btnCreateEvent.setOnClickListener(v -> {
            ...
            String endTime = binding.tvEndTime
                    .getText().toString();
            String location = binding.etLocation
                    .getText().toString().trim();
            String description = binding.etDescription
                    .getText().toString().trim();
            boolean autoReminders =
                    binding.switchAutoReminders.isChecked();
